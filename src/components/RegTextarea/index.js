    ...
    render() {
        ...
        return (
            <div onClick={this.props.onDivClick}  className={this.props.className?this.props.className:""}>
                {
                    this.props.label?<div className="r_textarea_label">{this.props.label}</div>:null
                }
                <div className="r_textarea displays">
                    <div className="flex1">
                    {
                        this.props.selectBox?this.props.value:<TextareaItem
                        clear

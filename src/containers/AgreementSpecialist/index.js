    ...
    return (
      ...
      <div className="my_row_part">
        ...
        <p style={{fontWeight:'bold'}}>【审慎阅读】您在申请登录流程中点击同意本协议之前，应当认真阅读本协议。请您务必审慎阅读、充分理解各条款内容，特别是免除或者限制责任的条款、法律适用和争议解决条款。如您对协议有任何疑问，可向检爱e行客服咨询。如您未满18周岁，或以其他形式被限制民事行为能力，请在监护人的陪同下阅读本协议。
          ...
          <p> 受检者的个人信息及检测结果属于个人隐私，未经参加者本人许可，不得向任何第三方泄露资料信息或用于商业用途。由于受检者个人原因导致信息外泄所带来的风险和不良后果，由受检者本人完全承担。
          </p>
        ...
        <p>受检者提供的样本必须符合规定的釆集要求和质量要求，并保证样本的真实性和有效性。若非检测公司及平台原因（包括但不限于取样专业人员的原因、样本转递人员的原因等）导致样本量不足、样本被污染或毁损等不合格情况而产生的检测时间延误，检测公司及平台不承担任何责任。若因样本质量问题，导致无法出具检测结果，经双方协商按照以下两种方式解决：</p>
        <p> 1）检测公司全额退款；</p>
        <p> 2）受检者自愿进行第二次重复检测，检测公司不需退还检测费用。受检者需要重新寄送样本，若样本质量再不合格导致检测结果无法出具或不正确，检测公司不承担任何责任。</p>
